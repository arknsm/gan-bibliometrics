...
| 姓名 | 学号 | 分工内容 |
| :--- | :--- | :--- |
| **高楠** | 2023001 | **项目总负责**：搭建Git版本控制体系，整合项目目录结构，统筹整体进度与代码合并。 |
| **向诗敏** | 2023002 | **数据检索与清洗**：负责构建氮化镓（GaN）检索式，执行文献检索，完成数据去重与标准化。 |
| **王思创** | 2023003 | **计量分析**：基于CiteSpace或Python代码，开展文献计量分析（发文量趋势、作者/机构分布、关键词共现）。 |
| **张帆** | 2023004 | **可视化与报告**：生成可视化图谱，撰写最终分析报告，整理并提交作业文档。 |
